                                ...
                                <div class="row" >
                                    <div class="col-lg-4 p-2" >
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">حركة الابهام</h5>
                                                <p class="card-text">
                                                    تشير حركه الابهام في لغة الجسد الى ان الشخص راضي عن الحالة
                                                    او تشير الى ان الشخص موافق على ما تقوله
                                    ...
                                    <div class="col-lg-4 p-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title">حركة رفع الاصبعين</h5>
                                                <p class="card-text">
                                                    تشير حركه رفع الاصبعين في لغة الجسد عند العرب الى ان  شخص يشعر بالسعادة
                                                    او تشير الى ان الشخص يشعر بالحماسة
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4 p-2">
                                        <div class="card">
                                            ...
                                            <div class="card-body ">
                                                <h5 class="card-title"> حركة الثلاث اصابع </h5>
                                                <p class="card-text">
                                                    تشير حركه رفع الثلاث اصابع في لغة الجسد عند العرب الى ان يشعر بالنصر
                                                    او تشير الى ان الشخص يشعر بالفوز
                                                </p>
                                            </div>
                                        </div>
                                    </div>
